...
exports.reorderTimelineEventsSchema = exports.updateTimelineEventSchema = exports.createTimelineEventSchema = void 0;
const joi_1 = __importDefault(require("joi"));
const currentYear = new Date().getFullYear();
const validateDay = (value, helpers) => {
...
exports.createTimelineEventSchema = joi_1.default.object({
...
exports.updateTimelineEventSchema = joi_1.default.object({
    year: joi_1.default.number()
        .integer()
        .min(1800)
        .max(currentYear + 10)
...
exports.reorderTimelineEventsSchema = joi_1.default.object({
    eventIds: joi_1.default.array()
